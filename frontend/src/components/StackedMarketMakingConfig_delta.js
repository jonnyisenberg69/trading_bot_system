...
const StackedMarketMakingConfig = ({ 
  ...
  const ensureDefaults = () => {
    const defaults = {
      ...
      // Delta targeting defaults
      target_inventory_source: 'manual',
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  value={normalizedConfig.target_inventory_source || 'manual'}
              ...
              <div className="flex items-center gap-3 bg-gray-700/40 rounded px-3 py-2">
                <input
                  type="checkbox"
                  checked={!!normalizedConfig.prevent_unprofitable_trades}
            ...
            {normalizedConfig.target_inventory_source === 'delta_calc' && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  <label className="block text-gray-400 text-sm mb-2">Delta Service URL</label>
                  <input
                    type="text"
                    value={normalizedConfig.delta_service_url || ''}
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={normalizedConfig.delta_refresh_seconds ?? 5}
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={normalizedConfig.delta_change_threshold_pct ?? 0.025}
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={normalizedConfig.delta_trade_fraction ?? 0.1}
                ...
                <div>
                  ...
                  <select
                    value={String(normalizedConfig.delta_target_sign ?? -1)}
