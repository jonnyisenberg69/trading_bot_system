...
async def get_all_positions(
    ...
    start_time: Optional[datetime] = Query(None, description="Start time for position calculation (ISO 8601)"),
    end_time: Optional[datetime] = Query(None, description="End time for position calculation (ISO 8601)"),
    ...
    try:
        ...
        async for session in get_session():
            ...
            positions = await position_manager.get_all_positions(symbol=symbol, start_time=start_time, end_time=end_time)
...
async def get_position_summary(
    ...
    try:
        ...
        async for session in get_session():
            ...
            summary = await position_manager.summarize_positions(start_time=start_time, end_time=end_time)
...
async def get_net_positions(
    ...
    try:
        ...
        async for session in get_session():
            ...
            if symbol:
                net_position = await position_manager.get_net_position(symbol, start_time=start_time, end_time=end_time)
                return {
                    "net_positions": {symbol: net_position},
                    "count": 1 if net_position['is_open'] else 0
                }
            else:
                net_positions = await position_manager.get_all_net_positions(start_time=start_time, end_time=end_time)
...
async def export_positions(
    ...
    try:
        ...
        async for session in get_session():
            ...
            positions = await position_manager.get_all_positions(start_time=start_time, end_time=end_time)
